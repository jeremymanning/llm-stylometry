...
\begin{figure*}[t]
  \centering
  \includegraphics[width=0.8\textwidth]{figs/loss_all_authors.pdf}
...
\begin{figure*}[t]
  \centering
  \includegraphics[width=0.8\textwidth]{figs/t_stats.pdf}


  \caption{\textbf{Same vs. other author comparisons, by
      model.}\textbf{D.} Each curve denotes, as a function of the
    ...
    held-out texts from all other authors. \textbf{E.} The average
...
\begin{figure*}[t]
  \centering
  \includegraphics[width=0.4\textwidth]{figs/source/loss_heatmap_ordered.pdf}


  \caption{\textbf{Confusion matrix.} The matrix displays the average cross-entropy loss assigned by models trained on each
 author's writing (column) to held-out texts from each author (row).}
...
\overline{L_j(i)}\right)$. Thus, Figure~\ref{fig:mds} is a visualization of
the relative ``distances" among our author set.

\begin{figure*}[t]
  \centering
  \includegraphics[width=0.4\textwidth]{figs/source/3d_MDS_plot.pdf}


  \caption{\textbf{Multidimensional scaling plot.} Three-dimensional
    MDS projection of the average cross-entropy loss matrix shown in
...
\begin{figure*}[t]
  \centering
  \includegraphics[width=0.6\textwidth]{figs/source/oz_losses.pdf}
