...
traditional methods that rely on subconscious stylistic habits. Evaluating
robustness against both intentional obfuscation and unintentional style drift
(e.g., authorial development over time) will be crucial for practical
applications.
...
traditional stylometric features or classification-based neural methods might
offset individual weaknesses. For instance, using cross-entropy loss as one
feature among many in an ensemble model could improve robustness while
maintaining interpretability through traditional features. Alternatively,
